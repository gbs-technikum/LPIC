...
public interface Constants {
    ...
    public static final String RUBRICID = "RUBRICID";
    public static final String RUBRIC = "RUBRIC";

    public static final String QUESTIONID = "QUESTIONID";
    public static final String QUESTION = "QUESTION";
    public static final String ART = "ART";
    public static final String TYPETEXT = "T"; // T >> Textantwortfrage
    public static final String TYPECHECK = "C"; // C >> Checkbox-Auswahlantwortfrage
